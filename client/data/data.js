export function jujeobData(nickName){
  return [
    ...
    `${nickName} 사진 보다가 심장 녹을까 봐 냉동실에서 사진 보는 중이에요`,
    `${nickName} 넌 뭐랄까.. 마치 베를린 같아. 왜냐하면 치명적인 독일 수도.`,
    `${nickName} 그거 기억나요? 사람들한테 ${nickName} 좋아하는 사람 손 접어 했더니 지구가 반으로 접힌거\n그거 겨우겨우 되돌렸잖아요 나 그 때 내 눈 앞에 우루과이 있어서 깜짝 놀랐잖아`,
    `${nickName}씨 예민한 질문일 수 도 있지만 너무 궁금해서 물어봅니다.\n${nickName}씨는 천국에서 쫓겨난 건가요 자발적으로 내려온건가요\n아님 추락 사고였나요?`,
